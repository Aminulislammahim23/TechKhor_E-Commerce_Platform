...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 02, 2026 at 08:39 PM
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('cash','bkash','nagad','card','cod') DEFAULT NULL,
...
--
ALTER TABLE `specifications`
  ADD CONSTRAINT `specifications_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE;
COMMIT;
